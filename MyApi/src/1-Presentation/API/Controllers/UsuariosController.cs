...
namespace API.Controllers
{
    ...
    public class UsuariosController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<UsuarioDTO>>> GetAllUsuarios(CancellationToken cancellationToken)
        {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<UsuarioDTO>> GetUsuarioById(Guid id, CancellationToken cancellationToken)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> UpdateUsuario(Guid id, RegisterUsuarioDTO usuarioDto, CancellationToken cancellationToken)
        {
            var idClaim = User.FindFirst(System.Security.Claims.ClaimTypes.NameIdentifier)?.Value;
            if (string.IsNullOrEmpty(idClaim) || !Guid.TryParse(idClaim, out var currentUserId))
                return Unauthorized();
